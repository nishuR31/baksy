  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-[#0B0F19]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full" style={{ background: 'radial-gradient(circle, rgba(139,92,246,0.15) 0%, transparent 70%)', filter: 'blur(60px)', animation: 'gradOrb1 18s ease-in-out infinite' }} />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full" style={{ background: 'radial-gradient(circle, rgba(91,140,255,0.12) 0%, transparent 70%)', filter: 'blur(50px)', animation: 'gradOrb2 22s ease-in-out infinite' }} />
      ...
      <div className="relative z-10 text-center px-6 max-w-2xl mx-auto">
        ...
        {/* Terminal hint */}
        <div className="mt-10 code-block max-w-sm mx-auto">
          ...
          <div className="p-3 text-left">
            ...
            <div className="font-mono text-[12px] text-[#22D3A0] mt-1">→ try /home or /docs</div>
          </div>
        </div>
      </div>
